        ...
        <div class="flex shadow-2xl rounded-xl overflow-hidden max-w-5xl w-full">
            ...
            <div class="w-full md:w-2/3 p-16 flex flex-col justify-center bg-white">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="password_confirmation" class="text-[var(--text-main)] text-base">パスワード（確認用）</label>
                        <div class="relative">
                            <img src="{{ asset('images/lock_24dp_E8EAED_FILL0_wght400_GRAD0_opsz24.svg') }}"
                                class="absolute top-1/2 left-3 transform -translate-y-[40%] w-6 h-6">
                            <input type="password" name="password_confirmation"
                                class="w-full px-10 py-3 mt-1 border {{ $errors->has('password_confirmation') ? 'border-red-500' : 'border-[var(--bg-dark)]' }} rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--bg-dark)] hover:scale-103 hover:shadow-lg transition-all duration-200" />
                        </div>
                    ...
                    <button type="submit"
                        class="text-[var(--text-main)] bg-[var(--accent-color)]
                            shadow-xl py-3 text-xl w-full mt-10 mb-10 rounded-xl 
